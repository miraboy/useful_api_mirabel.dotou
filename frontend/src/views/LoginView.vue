                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input id="email" v-model="credentials.email" type="email" required
                            ...
                            class="w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent disabled:bg-gray-100 disabled:cursor-not-allowed transition-all"
