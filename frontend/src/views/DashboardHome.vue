    ...
    <div class="p-6">
        ...
        <div class="bg-white overflow-hidden shadow rounded-lg mb-6">
            <div class="px-4 py-5 sm:p-6">
                ...
                <p class="text-gray-600">
                    You are logged in with email: <strong>{{ authStore.user?.email }}</strong>
                </p>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow mb-6">
            <div class="px-6 py-4 border-b border-gray-200">
                <h3 class="text-lg font-semibold text-gray-900">Module Management</h3>
                <p class="text-sm text-gray-600 mt-1">Enable or disable modules according to your needs</p>
            </div>
            <div class="p-6">
            ...
            <div class="flex">
                ...
                <div class="ml-3">
                    <p class="text-sm text-blue-700">
                        Activated modules will appear in the sidebar on the left for quick navigation.
                    </p>
                </div>
            </div>
        </div>
